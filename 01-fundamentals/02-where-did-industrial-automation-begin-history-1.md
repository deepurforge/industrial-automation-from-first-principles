...
![Ford Highland Park assembly line workers, 1913](https://commons.wikimedia.org/wiki/Special:FilePath/Ford_assembly_line_-_1913.jpg)
...
![Boulton and Watt steam engine](https://commons.wikimedia.org/wiki/Special:FilePath/Boulton_and_Watt_Steam_Engine_(7494783616).jpg)
...
![Jacquard loom with punched cards, National Museum of Scotland](https://commons.wikimedia.org/wiki/Special:FilePath/A%20Jacquard%20loom%20showing%20information%20punchcards%2C%20National%20Museum%20of%20Scotland.jpg)
...
![Three-phase industrial electric motor](https://commons.wikimedia.org/wiki/Special:FilePath/Electric_motor_3-phase.JPG)
...
![Replica of the first transistor, Bell Labs 1947](https://commons.wikimedia.org/wiki/Special:FilePath/Replica-of-first-transistor.jpg)
...
![Electromechanical relay control panel](https://commons.wikimedia.org/wiki/Special:FilePath/Panel_Sender_Relays.jpg)
...
![CNC milling machine](https://commons.wikimedia.org/wiki/Special:FilePath/CNC_Mill_1.jpg)
...
![SCADA operator at a control console, US Navy](https://commons.wikimedia.org/wiki/Special:FilePath/US%20Navy%20110328-N-OJ170-009%20Hideji%20Kawasaki%20operates%20the%20supervisory%20control%20and%20data%20acquisition%20%28SCADA%29%20system%20to%20balance%20an%20electrical%20load%20insid.jpg)
...
│   ├── boulton-watt-steam-engine.jpg
│   ├── watt-flyball-governor.jpg
│   ├── jacquard-loom.jpg
│   ├── electric-motor-3phase.jpg
│   ├── first-transistor-1947.jpg
│   ├── relay-control-panel.jpg
│   ├── cnc-machine.jpg
│   └── scada-console.jpg
│
└── animations/
...
- The single Mermaid diagram in Section 18 renders natively on GitHub — no image export needed.
- Every photograph above is hot-linked to Wikimedia Commons with its license and credit line intact. For a fully offline repository, download the originals into `/images` and switch to relative paths (e.g. `images/watt-flyball-governor.jpg`).
- Two images from your original planning table are still missing a clean public-domain source and are worth photographing or sourcing yourself: the **Modicon 084 PLC** (a documented but not freely-licensed photo exists via Schneider Electric's own history page) and a labeled **PLC I/O wiring diagram**.
- Reserve `.html` files in `/animations` for the genuinely interactive pieces and publish them via **GitHub Pages**, so the repository becomes an interactive learning site rather than a folder of Markdown.
- Keep a source/reference line under every image, exactly as done throughout this file — it's what makes the repository read as a credible research project.
